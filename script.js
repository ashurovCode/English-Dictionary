...
const meaningElement = document.getElementById("meanings");
...
async function fetchAPI(word) {
	...
	try {
		...
		infoTextElement.innerText = `Searching the meaning "${word}"...`;
		...
		infoTextElement.innerText = `ERROR_INTERNET_DISCONNECTE`;
	}
}
